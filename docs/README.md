# Proofpane — public docs (GitHub mirror)
...
2026-08-12; the canonical, always-current versions live on the site.
...
| [`proofpane-vs-grc-vs-logs.md`](proofpane-vs-grc-vs-logs.md) | Which layer each category answers for |
| [`who-approved-that.md`](who-approved-that.md) | Founder essay: why authorization is the audit question and the chain of trust ends at a customer-held key |

Also on GitHub:

- **Sample Evidence Pack + offline verifier** — [`../evidence/`](../evidence/): verify the audit-chain mechanism yourself, offline, before ever talking to us
- **Reference architecture** (CC BY 4.0 · DOI [10.5281/zenodo.21402331](https://doi.org/10.5281/zenodo.21402331)) — [Proofpane/architecture](https://github.com/Proofpane/architecture)

Not mirrored (large / interactive): the [use-cases PDF](https://proofpane.com/use-cases/Proofpane_UseCases_2026.pdf) (17 MB),
the [live demo](https://app.proofpane.com/login?demo=1), and the [recorded walkthroughs](https://proofpane.com/demos/).

Contact: Louie.Lu@proofpane.com
